    ...
    return (
        <>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Championing policies that impact the Global South from the heart of the USA. Advocacy, lobbying, and international partnerships for a fairer future."
                />
